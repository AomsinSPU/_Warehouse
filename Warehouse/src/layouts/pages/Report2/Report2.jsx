  ...
  return (
    <div className="nine0search">
      <div className="nine0product-search">
        ...
        {/* เพิ่มการคลิกที่ small-icon */}
        <img
          src="https://i.imgur.com/kfcWxdO.png" // เปลี่ยน URL ให้เป็น URL ของรูปที่ต้องการ
          alt="Small Icon"
